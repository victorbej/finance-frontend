...
[Финансовый Конструктор](https://victorbej.github.io/finance-frontend)
...
Проект разработан на React, применен функциональный подход, с использованием Хуков (useState). К проекту подключена библиотека [Material UI](https://mui.com/)
